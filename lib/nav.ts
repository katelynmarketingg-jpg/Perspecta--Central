...
export const NAV: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/custos", label: "Custos & Planos", icon: '<path d="M3 3v18h18"/><path d="M7 14l3-3 3 3 4-5"/>' },
    ],
  },
  {
    label: "Acessos",
...
export const PAGE_META: Record<string, { title: string; sub: string }> = {
  ...
  "/consumos": { title: "Uso & limites", sub: "Quanto cada empresa consome do plano" },
  "/dados": { title: "Dados reais", sub: "Onde estão as tabelas de clientes e logins de cada sistema" },
  "/custos": { title: "Custos & Planos", sub: "Monte planos e veja quanto custa manter tudo rodando" },
  "/pagamentos": { title: "Pagamentos & Cobrança", sub: "Cobrança recorrente, carência e inadimplência" },
  "/acessos": { title: "Acessos & logins", sub: "Empresas de cada sistema, criar acesso e histórico de login" },
