...
export const sistemas: Sistema[] = [
  { id: "commerce", nome: "Perspecta Commerce", cor: "#c9954f", url: "commerce.perspecta.com.br", repo: "perspecta-commerce", host: "Vercel", supabaseRef: "cmrc-xxxx", status: "sem_dados", statusSource: "mock", uptime: 99.92, versao: "1.8.0", ultimoDeploy: { estado: "sucesso", quando: "há 2 dias" }, bugs: [{ t: "Sincronização de estoque com atraso de ~3min", sev: "media", st: "aberto", d: "há 1 dia" }] },
