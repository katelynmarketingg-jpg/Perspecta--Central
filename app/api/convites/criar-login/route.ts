...
// criado de verdade. Hoje funciona pro Creator e pro Juris (são os únicos
// sistemas com API pronta pra criar escritório+admin); os outros ainda
...
export async function POST(req: Request) {
  ...
  if (c.sistemaId !== "creator" && c.sistemaId !== "juris") {
